...
public class Step1 {    // class S
    public static void main(String[] args) {    // main S
        ...
        // int num = Math.random() * 6              // 0~1 * 6 => 0 ~ 6 미만
        // int num = Math.random() * 6 + 1          // 0~1 * 6 + 1 => 1 ~ 7 미만
        int num = (int)(Math.random() * 6 + 1);      // (int) 0~1 * 6 + 1 => 1 ~ 7 미만

        // 2.
        Random random = new Random();
        // 클래스명 변수명 = new 클래스명()     // 클래스에 해당하는 객체 생성 (객체 만드는 이유 : 라이브러리 (미리 만들어 놓아서))
        // int num2 = random.nextInt();     // int 혀용범위내 난수 생성 +-21억정도 중 난수.
