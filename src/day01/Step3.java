...
public class Step3 {  // c S
    public static void main(String[] args) { // main()함수 // 실행시 필수 // m S
        ...
        int var1 = 0b1011;  // 2진수 : 데이터앞에 0b 1011[2] --> 11[10]
        ...
        // [p.42] byte 타입 [-128 ~ 127] : 1byte = 8bit -> 1[부호] + 7[값] -> 2의7승
        ...
        char c4 = 65;              System.out.println("c4 : " + c4);  // A

        // [p.49] 문자열[] : "" 끈따옴표 , 참조타입/클래스
        ...
        // [p.45] double [소수점 17자리 표현] : 8바이트 : 실수타입의 기본타입
        ...
        //boolean bool2 = 1;    1[int] 이므로 boolean 에 저장할 수 없다. [정수 가장 최소단위 바이트]
    } // m E
}  // c E
