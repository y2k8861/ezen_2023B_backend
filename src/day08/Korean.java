...
public class Korean {   // class S
    ...
    Korean(){};
    public Korean(String name, String ssn){ // 매개변수 명과 현재 클래스내 필드명과 중복 발생할 수 있다.
        // 그래서 매개변수 이름과 현재 클래스내 필드명과 다르면 this 쓸 필요가 없다.
        // 단 : 관례적으로 동일하게 사용한다. -> 문제 : 외부로 들어온 매개변ㅅ와 원래 객체내 있던 필드명과 충돌
    ...
    // 객체의 주소값 대신 객체의 필드정보 출력시 사용되는 방법
    // 오른쪽 클릭 -> 생성 -> toString()
    @Override
